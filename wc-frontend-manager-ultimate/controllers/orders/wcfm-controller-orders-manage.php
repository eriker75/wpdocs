        ...
        if (isset($wcfm_orders_manage_form_data['associate_products']) && !empty($wcfm_orders_manage_form_data['associate_products'])) {
            ...
            try {
                ...
                if (isset($wcfm_orders_manage_form_data['wcfm_om_shipping_method']) && !empty($wcfm_orders_manage_form_data['wcfm_om_shipping_method'])) {
                    ...
                    $shipping_method        = $shipping_methods[$wcfm_orders_manage_form_data['wcfm_om_shipping_method']] ?? '';
                    $shipping_method_title  = is_callable([$shipping_method, 'get_method_title']) ? $shipping_method->get_method_title() : '';
                    $shipping_rate = new WC_Shipping_Rate($wcfm_orders_manage_form_data['wcfm_om_shipping_method'], $shipping_method_title, isset($wcfm_orders_manage_form_data['wcfm_om_shipping_cost']) ? floatval($wcfm_orders_manage_form_data['wcfm_om_shipping_cost']) : 0, [], $wcfm_orders_manage_form_data['wcfm_om_shipping_method']);
                ...
                if (isset($wcfm_orders_manage_form_data['wcfm_om_comments']) && !empty($wcfm_orders_manage_form_data['wcfm_om_comments'])) {
                    $order->set_customer_note($wcfm_orders_manage_form_data['wcfm_om_comments']);
                }
                ...
                if (wc_coupons_enabled() && apply_filters('wcfm_orders_manage_discount', true) && isset($wcfm_orders_manage_form_data['wcfm_om_discount']) && !empty($wcfm_orders_manage_form_data['wcfm_om_discount'])) {
                    ...
                    if (!is_wp_error($new_coupon_id)) {
                        ...
                        $wc_coupon->set_props(apply_filters(
                            'wcfmu_orders_manage_discount_coupon_props',
                            [
                                'code'                 => $coupon_code,
