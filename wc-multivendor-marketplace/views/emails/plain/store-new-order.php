...
<style>
	.order-again,
	div.wc-booking-summary-actions,
	div.wc-appointment-summary-actions {
		display: none;
	}

	table.wcfm-order-details-table th,
	table.shop_table th,
	table.wcfm-order-details-table td,
	table.shop_table td {
		border: 1px solid #e5e5e5;
		color: #636363;
	}

	table.wcfm-order-total-table th {
		border-right: 0px;
	}

	table.wcfm-order-total-table td {
		border-left: 0px;
	}
</style>
...
?>
	<?php if (apply_filters('wcfm_is_allow_order_details_after_order_table', true)) {
