...
/*
 * Store multiple location table create
 */
if (!function_exists('store_multi_location_db_create')) {
    function store_multi_location_db_create() {
        global $wpdb;
        $collate = '';
        ...
        $create_tables_query[] = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "wcfm_store_locations` (
                                                        `ID` bigint(20) NOT NULL AUTO_INCREMENT,
                                                        `store_id` bigint(20) NOT NULL,
                                                        `name` varchar(255) NOT NULL,
                                                        `latitude` decimal(9,6) NOT NULL,
                                                        `longitude` decimal(9,6) NOT NULL,
                                                        `map_address` longtext NOT NULL,
        ...
        $create_tables_query[] = "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "wcfm_store_locations_meta` (
                                                        `ID` bigint(20) NOT NULL AUTO_INCREMENT,
