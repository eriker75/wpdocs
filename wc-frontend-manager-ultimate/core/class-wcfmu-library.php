    ...
    public function load_scripts($end_point)
    {
        ...
        switch ($end_point) {
            ...
            case 'wcfm-orders-details':
                ...
                wp_localize_script('wcfmu_orders_details_js', 'wcfmu_orders_details_i18n', [
                    'add_order_note_validation' => __( 'Order note field can not be blank', 'wc-frontend-manager-ultimate' )
                ] );
                break;
